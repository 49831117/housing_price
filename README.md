...
1. [試跑結果](https://github.com/49831117/housing_price/blob/master/.py/first.md)
...
1. 地址與地段前處理：
   1. 考量大多縣市 raw data 有準確率很高的鄉鎮市區資料，故僅需特別處理「新竹市」、「嘉義市」
      - 建立路名、路段對照表。
        - 新竹市要細分成：北區、東區、香山區
        - 嘉義市要細分成：東區、西區
   2. 大多數可透過鄉鎮市區 + 縣市代碼對照完成，但有少數型態需要特別注意：
...
2. 資料分析：
   1. 因聚焦在各鄉鎮市區建物相關交易中每坪單價數據統計，故在有效的 `392,158` 筆資料中，篩選出「建物」、「房地(土地+建物)」、「房地(土地+建物)+車位」三種交易標的，共計 `188,325` 筆。
3. [各鄉鎮市區中位數統計](https://github.com/49831117/housing_price/blob/master/.py/%E5%90%84%E9%84%89%E9%8E%AE%E5%B8%82%E5%8D%80%E4%B8%AD%E4%BD%8D%E6%95%B8%E7%B5%B1%E8%A8%88.md)
